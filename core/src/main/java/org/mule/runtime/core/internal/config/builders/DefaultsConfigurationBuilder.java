...
import org.mule.runtime.core.internal.orchestration.DefaultMuleOrchestratorManager;
...
public class DefaultsConfigurationBuilder extends AbstractConfigurationBuilder {
  ...
  protected void doConfigure(MuleContext muleContext) throws Exception {
    ...
    registerObject(MULE_ORCHESTRATOR_MANAGER, new DefaultMuleOrchestratorManager(), muleContext);
