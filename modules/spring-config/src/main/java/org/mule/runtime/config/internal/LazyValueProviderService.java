...
public class LazyValueProviderService implements ValueProviderService, Initialisable {
  ...
  @Override
  public ValueResult getFieldValues(Location location, String parameter, String fieldPath) {
    return initializeComponent(location)
        .orElseGet(() -> providerService.getFieldValues(location, parameter, fieldPath));
  }
